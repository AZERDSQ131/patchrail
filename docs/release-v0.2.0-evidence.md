...
- `patchrail ci benchmark` over 153 sanitized synthetic fixtures.
...
- Fixture hygiene: 153 / 153 fixtures passed.
- Benchmark: 153 total, 153 passed, 0 failed.
- Top-1 fixture accuracy: 1.0.
- Class coverage: 15 root-cause families.
