...
class PatchRailCITests(unittest.TestCase):
    ...
    def test_doctor_reports_local_first_requirements(self) -> None:
        ...
        self.assertEqual(payload["checks"]["ci_fixture_count"], 197)
    ...
    def test_ci_benchmark_checks_fixture_expectations(self) -> None:
        ...
        self.assertEqual(payload["total_cases"], 197)
        self.assertEqual(payload["passed"], 197)
        ...
        self.assertEqual(
            ...
            {
                "browser_test_failure": {"failed": 0, "passed": 7, "total_cases": 7},
                ...
                "security_scan_failure": {"failed": 0, "passed": 7, "total_cases": 7},
    ...
    def test_ci_benchmark_summary_only_omits_case_details(self) -> None:
        ...
        self.assertIn("- Total cases: `197`", markdown_proc.stdout)
