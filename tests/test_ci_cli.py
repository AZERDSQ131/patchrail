...
class PatchRailCITests(unittest.TestCase):
    ...
    def test_doctor_reports_local_first_requirements(self) -> None:
        ...
        self.assertEqual(payload["checks"]["ci_fixture_count"], 188)
    ...
    def test_ci_benchmark_checks_fixture_expectations(self) -> None:
        ...
        self.assertEqual(payload["total_cases"], 188)
        self.assertEqual(payload["passed"], 188)
        ...
        self.assertEqual(
            payload["class_summary"],
            {
                ...
                "dotnet_build_failure": {"failed": 0, "passed": 6, "total_cases": 6},
                "docker_build_failure": {"failed": 0, "passed": 6, "total_cases": 6},
                ...
                "security_scan_failure": {"failed": 0, "passed": 6, "total_cases": 6},
    ...
    def test_ci_benchmark_summary_only_omits_case_details(self) -> None:
        ...
        self.assertIn("- Total cases: `188`", markdown_proc.stdout)
