...
class PatchRailCITests(unittest.TestCase):
    ...
    def test_doctor_reports_local_first_requirements(self) -> None:
        ...
        self.assertEqual(payload["checks"]["ci_fixture_count"], 195)
    ...
    def test_ci_benchmark_checks_fixture_expectations(self) -> None:
        ...
        self.assertEqual(payload["total_cases"], 195)
        self.assertEqual(payload["passed"], 195)
        ...
        self.assertEqual(
            payload["class_summary"],
            {
                ...
                "ruby_bundle_failure": {"failed": 0, "passed": 9, "total_cases": 9},
    ...
    def test_ci_benchmark_summary_only_omits_case_details(self) -> None:
        ...
        self.assertIn("- Total cases: `195`", markdown_proc.stdout)
