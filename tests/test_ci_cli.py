...
class PatchRailCITests(unittest.TestCase):
    ...
    def test_doctor_reports_local_first_requirements(self) -> None:
        ...
        self.assertEqual(payload["checks"]["ci_fixture_count"], 206)
    ...
    def test_ci_benchmark_checks_fixture_expectations(self) -> None:
        ...
        self.assertEqual(payload["total_cases"], 206)
        self.assertEqual(payload["passed"], 206)
        ...
        self.assertEqual(
            payload["class_summary"],
            {
                ...
                "ruby_bundle_failure": {"failed": 0, "passed": 11, "total_cases": 11},
    ...
    def test_ci_benchmark_summary_only_omits_case_details(self) -> None:
        ...
        self.assertIn("- Total cases: `206`", markdown_proc.stdout)
