...
class PatchRailCITests(unittest.TestCase):
    ...
    def test_doctor_reports_local_first_requirements(self) -> None:
        ...
        self.assertEqual(payload["checks"]["ci_fixture_count"], 184)
    ...
    def test_ci_benchmark_checks_fixture_expectations(self) -> None:
        ...
        self.assertEqual(payload["total_cases"], 184)
        self.assertEqual(payload["passed"], 184)
        ...
        self.assertEqual(
            payload["class_summary"],
            {
                ...
                "node_dependency_install": {"failed": 0, "passed": 20, "total_cases": 20},
    ...
    def test_ci_benchmark_summary_only_omits_case_details(self) -> None:
        ...
        self.assertIn("- Total cases: `184`", markdown_proc.stdout)
