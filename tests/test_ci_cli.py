...
class PatchRailCITests(unittest.TestCase):
    ...
    def test_doctor_reports_local_first_requirements(self) -> None:
        ...
        self.assertEqual(payload["checks"]["ci_fixture_count"], 201)
    ...
    def test_ci_benchmark_checks_fixture_expectations(self) -> None:
        ...
        self.assertEqual(payload["total_cases"], 201)
        self.assertEqual(payload["passed"], 201)
        ...
        self.assertEqual(
            payload["class_summary"],
            {
                ...
                "java_build_failure": {"failed": 0, "passed": 8, "total_cases": 8},
    ...
    def test_ci_benchmark_summary_only_omits_case_details(self) -> None:
        ...
        self.assertIn("- Total cases: `201`", markdown_proc.stdout)
